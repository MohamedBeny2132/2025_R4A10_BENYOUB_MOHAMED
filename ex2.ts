...
(aucun objet)
Boîte de réception
Gafa-HardWare <momocraft00@gmail.com>
	
ven. 14 févr. 13:00 (il y a 4 jours)
...
class StudentRepository implements CRUD<etudiant>
{
    ...
    create(data: etudiant): Promise<etudiant> {
        throw new Error("Method not implemented.");
    }
    update(id: number, data: etudiant): Promise<etudiant> {
        throw new Error("Method not implemented.");
    }
    delete(id: number): Promise<void> {
        throw new Error("Method not implemented.");
...
class CourseRepository implements CRUD<cours>
{
    findMany(): Promise<cours[]> {
        throw new Error("Method not implemented.");
    }
    findOne(id: number): Promise<cours> {
        throw new Error("Method not implemented.");
    }
    create(data: cours): Promise<cours> {
        throw new Error("Method not implemented.");
    }
    update(id: number, data: cours): Promise<cours> {
        throw new Error("Method not implemented.");
    }
    delete(id: number): Promise<void> {
        throw new Error("Method not implemented.");
...
class SQLStudentRepository implements StudentRepository {
    ...
    async findOne(id: number): Promise<Student> {
        return null as any; // Retourne null pour l'exemple
    }
